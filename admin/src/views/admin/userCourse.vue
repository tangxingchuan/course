    ...
    <table id="simple-table" class="table  table-bordered table-hover">
      ...
      <td>
        <div class="hidden-sm hidden-xs btn-group">
            <button v-show="hasResource('010103')" v-on:click="editPassword(userCourse)" class="btn btn-xs btn-info">
                <i class="ace-icon fa fa-key bigger-120"></i>
            </button>
          <button v-show="hasResource('010101')"  v-on:click="edit(userCourse)" class="btn btn-xs btn-info">
            <i class="ace-icon fa fa-pencil bigger-120"></i>
          </button>
          <button v-show="hasResource('010102')" v-on:click="del(userCourse.id)" class="btn btn-xs btn-danger">

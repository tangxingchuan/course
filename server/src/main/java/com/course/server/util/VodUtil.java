...
//        request.setCoverURL("http://vod.aliyun.com/test_cover_url.jpg");
    ...
    public static void main(String[] argv) {
        //您的AccessKeyId
        String accessKeyId = "LTAI5tNytY3dJDUiKy4TAc2J";
        //您的AccessKeySecret
        String accessKeySecret = "hJnv27OzZCY6FcOl6QLLgzs0kWQ3mJ";
        //需要上传到VOD的本地视频文件的完整路径，需要包含文件扩展名
        String localFile = "/Users/tangtao/Desktop/course/admin/public/static/image/小节视频/test.mp4";

...
insert into `resource` values ('0101', '用户管理', 'system/userCourse', null, '01');
insert into `resource` values ('010101', '保存', null, '["/system/admin/userCourse/list", "/system/admin/user/save"]', '0101');
insert into `resource` values ('010102', '删除', null, '["/system/admin/userCourse/delete"]', '0101');
insert into `resource` values ('010103', '重置密码', null, '["/system/admin/userCourse/save-password"]', '0101');
